...
//                            console.log(assessment);
                            ...
                            //动态创建标签
                            $("<tr></tr>").addClass('a'+ currency_id + ' wl-projects-table__row').attr({id: currency_id}).click(function () {
                                if(d_a == '0'){
                                    alert('深度评估暂未开始');
                                }else {
                            ...
                            }).addClass("wl-project-name js-sort-class-name").appendTo($('.a' + currency_id));

                            /*$("<td></td>").addClass('b' + currency_id + " wl-project-hypeScore js-sort-class-hype").appendTo($('.a' + currency_id));
                            $("<div>" + project_type + "</div>").addClass("wl-project-wrapper").appendTo($('.b' + currency_id));*/

                            $("<td></td>").addClass('c' + currency_id + " wl-project-riskScore js-sort-class-risk hidden-xs").appendTo($('.a' + currency_id));
                            $("<div></div>").addClass('c0'+currency_id+" wl-project-wrapper").appendTo($('.c' + currency_id));
                            if(ishot == '高'){
                                $('<span>' + ishot + '</span>').css({color:'#6aa84f'}).appendTo($('.c0' + currency_id))
                            }
                            else if(ishot == '中'){
                                $('<span>' + ishot + '</span>').css({color:'#e69138'}).appendTo($('.c0' + currency_id))
                            }
                            else if(ishot == '低'){
                                $('<span>' + ishot + '</span>').css({color:'#cc0000'}).appendTo($('.c0' + currency_id))
                            }
                            else{
                                $('<span>' + ishot + '</span>').css({color:'#000'}).appendTo($('.c0' + currency_id))
                            }

                            $("<td></td>").addClass('c1' + currency_id + " wl-project-riskScore js-sort-class-risk hidden-xs").appendTo($('.a' + currency_id));
                            $("<div></div>").addClass('c2'+currency_id+" wl-project-wrapper").appendTo($('.c1' + currency_id));
                            if(risk_score == '高'){
                                $('<span>' + risk_score + '</span>').css({color:'#cc0000'}).appendTo($('.c2' + currency_id))
                            }
                            else if(risk_score == '中'){
                                $('<span>' + risk_score + '</span>').css({color:'#e69138'}).appendTo($('.c2' + currency_id))
                            }
                            else if(risk_score == '低'){
                                $('<span>' + risk_score + '</span>').css({color:'#6aa84f'}).appendTo($('.c2' + currency_id))
                            }
                            else{
                                $('<span>' + risk_score + '</span>').css({color:'#000'}).appendTo($('.c2' + currency_id))
                            }

                            $("<td></td>").addClass('f' + currency_id + " wl-project-rating js-sort-class-depth").appendTo($('.a' + currency_id));
                            $("<div></div>").addClass('g' + currency_id + " wl-project-wrapper").attr('title',as_title).appendTo($('.f' + currency_id));
                            $("<div></div>").addClass('hh' + currency_id + " wl-project-rating__value").appendTo($('.g' + currency_id));
                            if(assessment == 'A'){
                                $('<span>' + assessment + '</span>').css({color:'#19b050'}).appendTo($('.hh' + currency_id));
                            }
                            else if(assessment == 'B'){
                                $('<span>' + assessment + '</span>').css({color:'#91cf50'}).appendTo($('.hh' + currency_id));
                            }
                            else if(assessment == 'C'){
                                $('<span>' + assessment + '</span>').css({color:'#ffc013'}).appendTo($('.hh' + currency_id));
                            }
                            else if(assessment == 'D'){
                                $('<span>' + assessment + '</span>').css({color:'#fe6739'}).appendTo($('.hh' + currency_id));
                            }
                            else if(assessment == 'E'){
                                $('<span>' + assessment + '</span>').css({color:'#ff0016'}).appendTo($('.hh' + currency_id));
                            }
                            else{
                                $('<span>' + assessment + '</span>').css({color:'black',fontSize:'14px',fontWeight:'normal'}).appendTo($('.hh' + currency_id));
                            }
//                            $("<span>" + assessment + "</span>").appendTo($('.hh' + currency_id));
//                            $("<div></div>").addClass("wl-project-whiteBook").appendTo($('.hh' + currency_id));


                            $("<td></td>").addClass('i' + currency_id + " wl-project-date js-sort-class-start").appendTo($('.a' + currency_id));
                            $("<div></div>").addClass('j' + currency_id + " wl-project-wrapper").appendTo($('.i' + currency_id));
                            $("<div></div>").addClass('k' + currency_id + " wl-project-date__start").appendTo($('.j' + currency_id));
                            $("<div>" + price_cny + "</div>").addClass('k1' + currency_id+" wl-project-date__value").attr({title:last_updated}).appendTo($('.k' + currency_id));
                            // 升降放在这
                            if(updown == '1'){
                                $('<span> &uarr;</span>').css({color:'green'}).appendTo($('.k1' + currency_id)).delay(5000).hide(0);
                            }
                            if(updown == '2'){
                                $('<span> &darr;</span>').css({color:'red'}).appendTo($('.k1' + currency_id)).delay(5000).hide(0);
                            }

                            $("<td></td>").addClass('l' + currency_id + " wl-project-date js-sort-class-end hidden-xs").appendTo($('.a' + currency_id));
                            $("<div></div>").addClass('m' + currency_id + " wl-project-wrapper").appendTo($('.l' + currency_id));
                            $("<div></div>").addClass('n' + currency_id + " wl-project-date__end").appendTo($('.m' + currency_id));
                            $("<div>" + market_cap_cny + "</div>").addClass("wl-project-date__value").attr({title:last_updated}).appendTo($('.n' + currency_id));

                            $("<td></td>").addClass('r' + currency_id + " wl-project-price hidden-xs").appendTo($('.a' + currency_id));
                            $("<div></div>").addClass('r1' + currency_id + " wl-project-wrapper").appendTo($('.r' + currency_id));
                            $("<div></div>").addClass('r2' + currency_id + " wl-project-date__end").appendTo($('.r1' + currency_id));
                            $("<div>" + emarket + "</div>").addClass("wl-project-date__value").appendTo($('.r2' + currency_id));

                            $("<td></td>").addClass('o' + currency_id + " wl-project-price hidden-xs").appendTo($('.a' + currency_id));
                            $("<div></div>").addClass('o1' + currency_id + " wl-project-price").css({textAlign:'center',fontSize:'13px'}).appendTo($('.o' + currency_id));
                            if(datas.percent_change_24h < '0'){
                                $('<span>'+datas.percent_change_24h+"%"+'</span>').css({color:'red'}).appendTo($('.o1' + currency_id));
                            }
                            if(datas.percent_change_24h > '0'){
                                $('<span>'+datas.percent_change_24h+"%"+'</span>').css({color:'green'}).appendTo($('.o1' + currency_id));
                            }
                            if(datas.percent_change_24h == null){
                                $('<span>'+0+"%"+'</span>').css({color:'red'}).appendTo($('.o1' + currency_id));
                            }

                            $("<td></td>").addClass('d' + currency_id + " wl-project-investScore js-sort-class-potential").appendTo($('.a' + currency_id));
                            $("<div></div>").addClass('e' + currency_id + " wl-project-wrapper").appendTo('.d' + currency_id);
                            $("<div></div>").addClass('e1' + currency_id +" wl-project-investScore__value").appendTo($('.e' + currency_id));
//                            $("<span>" + multiple + "</span>").appendTo($('.e1' + currency_id ));

                            if(multiple >= '2.0'){
                                $('<span>' + multiple + '</span>').css({color:'green'}).appendTo($('.e1' + currency_id ));
                            }
                            else if(multiple < '1.0'){
                                $('<span>' + multiple + '</span>').css({color:'red'}).appendTo($('.e1' + currency_id ));
                            }
                            else if(multiple >= '1.0' && multiple < '2.0'){
                                $('<span>' + multiple + '</span>').css({color:'black'}).appendTo($('.e1' + currency_id ));
                            }
                        });
