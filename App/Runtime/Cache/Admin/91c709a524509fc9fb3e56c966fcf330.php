...
<div class="projectUpload">
    <form action="/index.php/Admin/Assessment/upd" method="post" enctype="multipart/form-data">
        ...
        <div class="main-container">
            ...
            <div class="main-container-top">
                ...
                <div class="main-project-name">
                    <span>成立时间:</span>
                    <input type="text" name="set_up" id="txt_calendar" class="allName" readonly="readonly" onfocus="showDate()" value="<?= $result['set_up']; ?>">
                </div>
                <div class="main-project-currency">
                    <span>官方网站:</span>
                    <input type="text" name="web" class="currency" value="<?= $result['web']; ?>">
                </div>
                ...
                <!--<div style="display: flex">-->
                    ...
                    <!--<div style="flex: 1" class="container-bottom-right">-->
                        ...
                        <!--<div class="socialBox">-->
                            <!--<div class="social">-->
                                <!--<label class="socialLinkAddress">链接地址:</label>-->
                                <!--<?php foreach($result['s_link'] as $s_l){ ?>-->
                                <!--<input type="text" class="socialFocus" value="<?= $s_l; ?>" name="s_link[]"><img class="deleteSocial" src="/Public/Admin/images/indexImg/delete.png"/>-->
                                <!--<?php } ?>-->
                            <!--</div>-->
                        <!--</div>-->
                    ...
                    <!--<div style="flex: 1" class="container-bottom-right">-->
                        ...
                        <!--<div class="ExchangeBox">-->
                            <!--<div class="Exchange">-->
                                ...
                                <!--<?php foreach($result['exchange'] as $ex){ ?>-->
                                <!--<input type="text" class="linkFocus" value="<?= $ex; ?>" name="exchange[]"><img class="deleteExchange" src="/Public/Admin/images/indexImg/delete.png"/>-->
                                <!--<?php } ?>-->
                            <!--</div>-->
                        <!--</div>-->
            ...
            <div class="main-container-bottom">
                <div>
                    ...
                    <textarea name="content" id="textarea1" style="height:400px;max-height:500px;"><?= $result['d_assessment']; ?></textarea>
                </div>
            </div>
